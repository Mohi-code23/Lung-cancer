...
positiveFolder = "H:\lungcancer dataset\lung _cancer_positive_images"; % Folder containing positive DICOM files
negativeFolder = "H:\lungcancer dataset\lung_cancer_negative_images"; % Folder containing negative DICOM files
